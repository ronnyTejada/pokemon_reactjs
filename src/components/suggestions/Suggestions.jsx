...
function Suggestions({suggestions,pokemons, setPokemonWanted, search, filter, favoritesPokemons}) {
        ...
        <>
           ...
           {suggestions.length > 0 &&
                     ...
                     {suggestions.map(pkm=>{
                         ...
                         return(
                             <List_Item onClick={()=>getSearchPokemon(pkm.name)}>{pkm.name}</List_Item>
                         )
                     })
